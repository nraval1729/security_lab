...
function handleSignup1(req,res,next,errors,err,data)
{
  ...
  var q = "INSERT INTO USER ( userName, firsName, lastName, password, email) VALUES($1, $2, $3, $4, $5);"
...
function prepareUserData(user,next)
{
   ...
   //    user.userId + "," + stocks + "," + funds + "," + bonds + ")";
    ...
    var q = "INSERT INTO Allocation (userId, stocks, funds, bonds) VALUES ($1, $2, $3, $4, $5);"
